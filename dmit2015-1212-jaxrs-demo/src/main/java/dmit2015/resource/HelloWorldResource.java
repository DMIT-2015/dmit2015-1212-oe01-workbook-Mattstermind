...
//        File imageFile = new File(URI.create("file:///home/user2015/Pictures/globe2.jpeg"));
//        return Response
//                .ok(imageFile)
//                .header("Content-Disposition","attachment; filename=globe2.jpeg")
//                .build();
        InputStream is = getClass().getResourceAsStream("/images/globe1.png");
         return Response
                 .ok(is)
                 .header("Content-Disposition","attachment; filename=globe1.png")
                 .build();
    }
}